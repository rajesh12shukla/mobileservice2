<%@ Page Language="C#" MasterPageFile="~/CustomerReportMaster.master" AutoEventWireup="true"
    CodeFile="CustomersReport.aspx.cs" Inherits="CustomersReport" Title="" EnableEventValidation="false" %>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Customer Report Preview</asp:Label></li>
                                                    ...
                                                    <table id="tblCity" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpCity" CssClass="form-control" runat="server" AddJQueryReference="false" UseButtons="false"
