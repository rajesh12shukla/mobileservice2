<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.master" AutoEventWireup="true" CodeFile="ARAgingReport.aspx.cs" Inherits="ARAgingReport" %>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">AR Aging Report</asp:Label></li>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="com-cont">
                    <div class="table-scrollable" style="border: none">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <rsweb:ReportViewer ID="rvInvoices" runat="server" Width="1250px" Height="1500px"
                                BorderColor="Gray" BorderStyle="None" BorderWidth="1px"  PageCountMode="Actual"
                                AsyncRendering="false" ShowZoomControl="False" OnReportRefresh="rvInvoices_ReportRefresh" > <%--ShowPageNavigationControls="false"--%>
                            </rsweb:ReportViewer>
                        </div>
                    </div>
                                            ...
                                            <div class="form-col">
                                                <div>
                                                    <asp:TextBox ID="txtBody" runat="server" TextMode="MultiLine" Columns="50"
                                                        Rows="5" CssClass="form-control" Text="This is report email sent from Mobile Office Manager. Please find the AR Aging Report By Due Date attached."></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </asp:Panel>
