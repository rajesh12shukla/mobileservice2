<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.master" AutoEventWireup="true" CodeFile="APAgingReport.aspx.cs" Inherits="APAgingReport" %>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">AP Aging Report</asp:Label></li>
                            ...
                            <ul class="nav navbar-nav pull-right">
                                <li class="dropdown dropdown-user">
                                    ...
                                    <ul id="dynamicUI" class="dropdown-menu dropdown-menu-default">
                                        ...
                                        <li style="margin-left: 0px;"> <a href="BillsReport.aspx"><span>Bill Summary Report</span><div style="clear: both;"></div>
                                        </a></li>
                                    </ul>
                                </li>
                            </ul>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="com-cont">
                        ...
                        <div class="col-lg-12 col-md-12">
                          ...
                          <ContentTemplate>
                            ...
                            <%--        <label style="margin-left: 39px; margin-bottom: 19px;">
                                        ...
                                        <asp:DropDownList ID="ddlInvoice" runat="server" CssClass="form-control input-sm input-small" TabIndex="1"  Width="130px"
                                             OnSelectedIndexChanged="ddlInvoice_SelectedIndexChanged" AutoPostBack="true">
                                              <%--  <asp:ListItem Value="0">All </asp:ListItem>--%>
                                                <asp:ListItem Value="1">Outstanding </asp:ListItem>
                                                <asp:ListItem Value="2">Due </asp:ListItem>
                                        ...
                                        <asp:TextBox ID="txtSearchDate" runat="server" CssClass="form-control input-sm input-small" autocomplete="off"
                                                    MaxLength="10" Width="130px"></asp:TextBox>
                                        <asp:CalendarExtender ID="txtSearchDate_CalendarExtender" runat="server" Enabled="True"
                                            TargetControlID="txtSearchDate">
                                        </asp:CalendarExtender>
                    ...
                    <asp:UpdatePanel ID="updRvBill" runat="server">
                          <ContentTemplate>
                        <div class="col-lg-12 col-md-12">
                            <rsweb:ReportViewer ID="rvBills" runat="server" Width="1280px" Height="1500px"
                                BorderColor="Gray" BorderStyle="None" BorderWidth="1px"  PageCountMode="Actual"
                                AsyncRendering="false" ShowZoomControl="False" OnReportRefresh="rvBills_ReportRefresh" > <%--ShowPageNavigationControls="false"--%>
                            </rsweb:ReportViewer>
                        </div>
                         </ContentTemplate>
                         <Triggers>
